...
public class JavaAgentIT {
    ...
    public void agentLoads() throws IOException, InterruptedException {
        ...
        final String keystore = resolveRelativePathToResource("keystore.jks");
        final String credentials = resolveRelativePathToResource("credentials.txt");

        final String javaagent = "-javaagent:" + buildDirectory + "/" + finalName + ".jar=" + port + ":" + config + ":" + keystore + ":" + credentials;
